...
namespace RpcSocket.Messaging.Tests
{
    ...
    public class SocketMessageTests
    {
        ...
        //    var expected = encoding.GetBytes(socketMessage.GetMessageString());
        ...
        //    byte[] stringToBytes = SocketMessage.Encoding.GetBytes(socketMessage.GetMessageString());
        ...
        //    Debug.Write(socketMessage.GetMessageString());
